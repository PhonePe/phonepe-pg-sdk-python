...
class TestRequestDeserialization(TestCase):
    ...
    def test_checkout_deserialization(self):
        ...
        resp2 = """{"merchantOrderId": "moid", "amount": 10, "metaInfo": {"udf1": "sad"}, "paymentFlow": {"type": "PG_CHECKOUT", "message": null, "merchantUrls": {"redirectUrl": "redirect-url"}, "paymentModeConfig": {"enabledPaymentModes": [{"type": "UPI_INTENT"}, {"type": "UPI_COLLECT"}, {"type": "UPI_QR"}, {"type": "NET_BANKING"}, {"type": "CARD", "cardTypes": ["DEBIT_CARD", "CREDIT_CARD"]}], "disabledPaymentModes": null}}, "expireAfter": null, "disablePaymentRetry": null}"""
        ...
        resp3 = """{"merchantOrderId": "moid", "amount": 10, "metaInfo": {"udf1": "sad", "udf5": "udf5"}, "paymentFlow": {"type": "PG_CHECKOUT", "message": null, "merchantUrls": {"redirectUrl": "redirect-url"}, "paymentModeConfig": {"enabledPaymentModes": [{"type": "UPI_INTENT"}, {"type": "UPI_COLLECT"}, {"type": "UPI_QR"}, {"type": "NET_BANKING"}, {"type": "CARD", "cardTypes": ["DEBIT_CARD", "CREDIT_CARD"]}], "disabledPaymentModes": null}}, "expireAfter": null, "disablePaymentRetry": null}"""
